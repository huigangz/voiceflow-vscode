...
PvRecorder is distributed unmodified from the official npm package (minimal runtime:
`package.json`, `dist/*.js`, `lib/windows/amd64/pv_recorder.node`). The full text of the
Apache License 2.0 is included below as required by that license.
...
Applies to: `@picovoice/pvrecorder-node` (Copyright 2019-2023 Picovoice Inc.), and to the
Apache-2.0-licensed portions of the OpenCC dictionaries.
